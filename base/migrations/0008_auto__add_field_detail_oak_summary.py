...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Detail.oak_summary'
        db.add_column(u'base_detail', 'oak_summary',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Detail.oak_summary'
        db.delete_column(u'base_detail', 'oak_summary')
    ...
    models = {
        u'base.detail': {
            ...
            'oak_summary': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
