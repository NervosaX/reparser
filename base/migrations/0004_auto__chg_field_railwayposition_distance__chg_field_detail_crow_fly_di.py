...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'base_railwayposition', 'distance', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Detail.crow_fly_distance'
        db.alter_column(u'base_detail', 'crow_fly_distance', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Detail.estimated_speed'
        db.alter_column(u'base_detail', 'estimated_speed', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Detail.cable_length'
        db.alter_column(u'base_detail', 'cable_length', self.gf('django.db.models.fields.FloatField')())
